...
2. **Minimizing time shortens the path 12× but does not straighten it.** `R_length` falls
   from 21.9 to 1.95 across the horizon sweep while `D_path` stays pinned at 0.41–0.51 rad.
...
| --- | --- | --- | --- | --- | --- |
| 0.25 | 0.867 | 5346 | **1.95** | 0.514 | **0.408** |
| 0.50 | 0.927 | 2513 | 4.60 | 0.217 | 0.439 |
| 1.00 | 0.978 | 1360 | 11.9 | 0.084 | 0.510 |
| 2.00 | 0.991 | 698 | 21.9 | 0.046 | 0.493 |

**Time pressure shortens the path but does not move it toward the geodesic.** `R_length`
varies 12×; `D_path` stays within 0.41–0.51 and is not even monotonic (T=1.0 exceeds T=2.0),
putting run-to-run scatter at ≈ ±0.05.
